...
Should you want to create additional sessions (and you should) with meaningful names, simply append the session name to the `dam` command, *a la*:
$`dam fubar`
dam does not support multi-word session names at this time.
